...
##
    ...
    for run in ['0']:#['0','1','2']:
        ...
        for t in ts:
            temp = np.loadtxt(datadir + "dloc" + str(t) + ".csv", delimiter=",")
            #print(t,len(temp))
            dlocs[0, t - step_size  : t] = temp
        ...
        lwseats = seats[(np.abs(dlocs)<lbound)]    
        uwseats = seats[(np.abs(dlocs)>ubound)]  
        lmms = mms[(np.abs(dlocs)<lbound)]   
        umms = mms[(np.abs(dlocs)>ubound)] 
        lpbs = pbs[(np.abs(dlocs)<lbound)]   
        upbs = pbs[(np.abs(dlocs)>ubound)] 
        lpgs = pgs[(np.abs(dlocs)<lbound)]   
        upgs = pgs[(np.abs(dlocs)>ubound)] 
        ...
        plt.legend()
        plt.savefig(newdir+"mms_comparison2l1_signed.png")
        ...
        plt.legend()
        plt.savefig(newdir+"mms_comparisonul1_signed.png")
        ...
        plt.legend()
        plt.savefig(newdir+"pbs_comparison2l1_signed.png")
        ...
        plt.legend()
        plt.savefig(newdir+"pbs_comparisonul1_signed.png")
        ...
        plt.legend()
        plt.savefig(newdir+"pgs_comparison2l1_signed.png")
        ...
        plt.legend()
        plt.savefig(newdir+"pgs_comparisonul1_signed.png")
        ...
        plt.legend()
        plt.savefig(newdir+"seats_comparison2l1_signed.png")
        ...
        plt.legend()
        plt.savefig(newdir+"seats_comparison2u1_signed.png")
        ...
        plt.legend()
        plt.savefig(newdir+"seats_comparison3l1_signed.png")
        ...
        plt.legend()
        plt.savefig(newdir+"seats_comparison3u1_signed.png")
        ...
        plt.legend()
        plt.savefig(newdir+"seats_comparison2l1ss_signed.png")
        ...
        plt.legend()
        plt.savefig(newdir+"seats_comparison2u1ss_signed.png")
        ...
        plt.legend()
        plt.savefig(newdir+"seats_comparison3l1ss_signed.png")
        ...
        plt.legend()
        plt.savefig(newdir+"seats_comparison3u1ss_signed.png")
        ...
        sns.distplot(uwseats, kde=False, bins=[x for x in range(int(min(seats[0,:]))-1,int(max(seats[0,:]))+2)],color='orange',label='Large Dislocation')
        plt.legend()
        plt.savefig(newdir+"seats_comparison2all1_signed.png")
        ...
        plt.legend()
        plt.savefig(newdir+"seats_comparison3all1_signed.png")
        ...
        plt.legend()
        plt.savefig(newdir+"seats_comparison2all1sss_signed.png")
        ...
        plt.legend()
        plt.savefig(newdir+"seats_comparison3all1sss_signed.png")

        plt.close()

        """
            
        lbound = np.percentile(dlocs, 5)
        ubound = np.percentile(dlocs, 95)
        
        #for i in range(max_steps):
        #    if
        
        lwseats = seats[(dlocs<lbound)]    
        uwseats = seats[(dlocs>ubound)]    
        
        plt.figure()
        sns.distplot(seats, kde=False, bins = [x for x in range(int(min(seats[0,:]))-1,int(max(seats[0,:]))+2)], color='gray',label = 'All Plans')
        sns.distplot(lwseats, kde=False, bins=[x for x in range(int(min(seats[0,:]))-1,int(max(seats[0,:]))+2)],color='green',label='Small Dislocation')
        plt.legend()
        plt.savefig(newdir+"seats_comparison2l5_signed.png")
        ...
        sns.distplot(uwseats, kde=False, bins=[x for x in range(int(min(seats[0,:]))-1,int(max(seats[0,:]))+2)],color='orange',label='Large Dislocation')
        plt.legend()
        plt.savefig(newdir+"seats_comparison2u5_signed.png")
        ...
        sns.distplot(lwseats, kde=False, bins=[x for x in range(int(min(seats[0,:]))-1,int(max(seats[0,:]))+2)],color='green', norm_hist = True, label='Small Dislocation')
        plt.legend()
        plt.savefig(newdir+"seats_comparison3l5_signed.png")
        ...
        sns.distplot(uwseats, kde=False, bins=[x for x in range(int(min(seats[0,:]))-1,int(max(seats[0,:]))+2)],color='orange', norm_hist = True, label='Large Dislocation')
        plt.legend()
        plt.savefig(newdir+"seats_comparison3u5_signed.png")
        ...
        sns.distplot([x+1 for x in lwseats], kde=False, bins=[x+.15 for x in range(int(min(seats[0,:]))-1,int(max(seats[0,:]))+2)],color='green',label='Small Dislocation',hist_kws={"rwidth":.3,"align":"left"})
        plt.legend()
        plt.savefig(newdir+"seats_comparison2l5ss_signed.png")
        ...
        sns.distplot([x+1 for x in uwseats], kde=False, bins=[x+.15 for x in range(int(min(seats[0,:]))-1,int(max(seats[0,:]))+2)],color='orange',label='Large Dislocation',hist_kws={"rwidth":.3,"align":"left"})
        plt.legend()
        plt.savefig(newdir+"seats_comparison2u5ss_signed.png")
        ...
        sns.distplot([x+1 for x in lwseats], kde=False, bins=[x+.15 for x in range(int(min(seats[0,:]))-1,int(max(seats[0,:]))+2)],color='green', norm_hist = True, label='Small Dislocation',hist_kws={"rwidth":.3,"align":"left"})
        plt.legend()
        plt.savefig(newdir+"seats_comparison3l5ss_signed.png")
        ...
        sns.distplot([x+1 for x in uwseats], kde=False, bins=[x+.15 for x in range(int(min(seats[0,:]))-1,int(max(seats[0,:]))+2)],color='orange', norm_hist = True, label='Large Dislocation',hist_kws={"rwidth":.3,"align":"left"})
        plt.legend()
        plt.savefig(newdir+"seats_comparison3u5ss_signed.png")
        ...
        sns.distplot(uwseats, kde=False, bins=[x for x in range(int(min(seats[0,:]))-1,int(max(seats[0,:]))+2)],color='orange',label='Large Dislocation')
        plt.legend()
        plt.savefig(newdir+"seats_comparison2all5_signed.png")
        ...
        sns.distplot(uwseats, kde=False, bins=[x for x in range(int(min(seats[0,:]))-1,int(max(seats[0,:]))+2)],color='orange',label='Large Dislocation', norm_hist = True)
        plt.legend()
        plt.savefig(newdir+"seats_comparison3all5_signed.png")
        ...
        sns.distplot([x+1 for x in uwseats], kde=False, bins=[x+.25 for x in range(int(min(seats[0,:]))-1,int(max(seats[0,:]))+2)],color='orange',label='Large Dislocation',hist_kws={"rwidth":.25,"align":"left"})
        plt.legend()
        plt.savefig(newdir+"seats_comparison2all5sss_signed.png")
        ...
        sns.distplot([x+1 for x in uwseats], kde=False, bins=[x+.25 for x in range(int(min(seats[0,:]))-1,int(max(seats[0,:]))+2)],color='orange', norm_hist = True, label='Large Dislocation',hist_kws={"rwidth":.25,"align":"left"})
        plt.legend()
        plt.savefig(newdir+"seats_comparison3all5sss_signed.png")

        plt.close()
        
                   
        meds.append(np.percentile(dlocs,50))
        p5.append(np.percentile(dlocs,5))
        p25.append(np.percentile(dlocs,25))
        p75.append(np.percentile(dlocs,75))
        p95.append(np.percentile(dlocs,95))
        mins.append(np.min(dlocs))
        maxs.append(np.max(dlocs))
...
plt.savefig(newdir+"compare_dislocations_signed.png")
plt.close()
...
plt.legend()
plt.xticks(range(len(meds)),names,rotation=90,fontsize=6)
plt.savefig(newdir+"compare_dislocations_mm_signed.png")
plt.close()
...
plt.legend()
plt.xticks(range(len(meds)),names,rotation=90,fontsize=6)
plt.savefig(newdir+"compare_dislocations_e_signed.png")
plt.close()
...
plt.legend()
plt.xticks(range(len(meds)),names,rotation=90,fontsize=6)
plt.savefig(newdir+"compare_dislocations_mm_e_signed.png")
plt.close()
"""
