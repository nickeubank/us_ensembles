...
for state_fips in fips_list:
    ...
    for run in ['0']:#['0','1','2']:
        ...
        o_seats = np.loadtxt(o_datadir + "hmss100.csv", delimiter=",")
        o_mms = np.loadtxt(o_datadir + "mmsadloc100.csv", delimiter=",") 
        o_pbs = np.loadtxt(o_datadir + "pbs100.csv", delimiter=",")
        o_pgs = np.loadtxt(o_datadir + "pgs100.csv", delimiter=",")
        o_egs = np.loadtxt(o_datadir + "ega100.csv", delimiter=",")       
