...
def VRAify_seeds(fips_seed):
    ...
    for iteration in range(1):
        ...
        bbound = bvap_dict[fips_seed[0]][fips_seed[1]]
        hbound = hvap_dict[fips_seed[0]][fips_seed[1]]
        
        percbound = seed2bound[fips_seed[1]]
        

        graph = Graph.from_json(f'../../20_intermediate_files/precinct_graphs/seeded/precinct_graph_{fips_seed[0]}_seed{fips_seed[1]}.json')
        print('starting',fips_seed[0],fips_seed[1])
