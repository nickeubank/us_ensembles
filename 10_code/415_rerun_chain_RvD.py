...
def join_and_evaluate_dislocation(state_fips):
    ...
    for run in ['0']:#['0','1','2']:
        ...
        newdir = f"../../../Dropbox/dislocation_intermediate_files/100_ensembles/{state_fips}_run{run}/rerun5/"
        ...
        for t in ts:
            ...
            for step in range(step_size):
                ...
                filter_indices = state_points["dislocate"]>0
                #print(filter_indices)
                #print(sum(filter_indices))
                #afbd
                ...
                Rdlocs[-1].append(sum(filter_indices))
                Ddlocs[-1].append(num_points-sum(filter_indices))
