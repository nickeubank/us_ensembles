...
##
    ...
    for run in ['0']:#['0','1','2']:
        ...
        #newdir = f"../../../Dropbox/dislocation_intermediate_files/Filtered_Swung_Plots/Comparisons/Run{run}/{state_fips}_"
...
newdir = f"../../../../Dropbox/dislocation_intermediate_files/Filtered_Swung_Plots_VRA/Comparisons/Run{run}/"
