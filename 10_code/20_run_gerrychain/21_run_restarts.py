...
if state_fips not in bvap_dict.keys():
    print('this state doesnt have seeds!')
    import sys
    sys.exit()
...
graph = Graph.from_json(f"./restart_seed_{state_fips}_run{run}_restart{restart}.json")
